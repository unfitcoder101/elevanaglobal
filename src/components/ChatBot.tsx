...
const ChatBot: React.FC = () => {
  ...
  return (
    <>
      ...
      {/* Chat Window */}
      {isOpen && (
        <Card className="fixed bottom-6 right-6 w-[calc(100vw-3rem)] sm:w-80 h-[70vh] sm:h-96 shadow-elegant z-50 flex flex-col max-w-[calc(100vw-3rem)] max-h-[calc(100vh-3rem)]">
